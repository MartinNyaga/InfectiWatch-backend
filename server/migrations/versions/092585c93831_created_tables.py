...
Revision ID: 092585c93831
Revises: 
Create Date: 2023-10-30 20:04:18.803635
...
def upgrade():
    ...
    with op.batch_alter_table('diseases', schema=None) as batch_op:
        batch_op.create_index(batch_op.f('ix_diseases_disease_name'), ['disease_name'], unique=True)
